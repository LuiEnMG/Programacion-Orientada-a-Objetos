...
public class MenuEmpleadosController {
    ...
    private GestionEmpleadosMorales gestor = new GestionEmpleadosMorales();
    ...
    public void initialize() {
        ...
        registrar.setOnAction(evento -> {
            ...
            // Validación para ID: solo números
            ...
            contenido.getChildren().add(puesto);
            ...
            aceptar.setOnAction(event -> {
                ...
                String puesto_empleado = puesto.getText().trim();
                ...
                if (puesto_empleado.isEmpty()) {
                    mostrarAlerta("Error", "El puesto es obligatorio");
                    return;
                }
                ...
                if (!idExiste) {
                    try {
                        ...
                        mostrarAlerta("Éxito", "Empleado registrado exitosamente");
                        cancelar.fire();
                    } catch (NumberFormatException e) {
                        mostrarAlerta("Error", "Formato numérico inválido en edad o salario");
                    }
                }
            });
    ...
    private VBox crearTarjetaEmpleado(Empleado empleado) {
        ...
        Label direccionLabel = new Label("Dirección: " + empleado.getDireccion());
    ...
    private HBox registrarEntradaSalida(Empleado empleado) {
        ...
        ControlAccesoEmpleadosMorales acceso_empleados = new ControlAccesoEmpleadosMorales();
        ...
        botonEntrada.setOnAction(event -> {
            ...
            mostrarAlerta("Éxito", "Entrada registrada para " + empleado.getNombre());
            contenido.getChildren().clear();
        });
        botonSalida.setOnAction(event -> {
            acceso_empleados.registrarSalida(empleado.getId(), empleado.getNombre(), empleado.getApellido());
            mostrarAlerta("Éxito", "Salida registrada para " + empleado.getNombre());
            contenido.getChildren().clear();
        });
    ...
    private void mostrarFormularioActualizacion(Empleado empleado) {
        ...
        botonGuardar.setOnAction(event -> {
            ...
            try {
                ...
                mostrarAlerta("Éxito", "Empleado actualizado exitosamente");
                contenido.getChildren().clear();
            } catch (NumberFormatException e) {
                mostrarAlerta("Error", "Formato numérico inválido en edad o salario");
            }
    ...
    private void mostrarFormularioEliminar(Empleado empleado) {
        ...
        botonEliminar.setOnAction(event -> {
            ...
            mostrarAlerta("Éxito", "Empleado eliminado exitosamente");
            contenido.getChildren().clear();
        });
