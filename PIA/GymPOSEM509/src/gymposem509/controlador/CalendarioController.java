...
import gymposem509.modelo.ClaseGrupal;
import gymposem509.modelo.GestionCalendarioClases;
...
public class CalendarioController {
    ...
    private GestionCalendarioClases gestor = new GestionCalendarioClases();
    ...
    public void initialize() {
        ...
        // Cargar clases desde el archivo más reciente
    ...
    private void registrarClase() {
        try {
            ...
            mostrarAlerta("Formato de hora inválido", "Usa el formato HH:MM (por ejemplo 18:30).");
        } catch (NumberFormatException ex) {
            mostrarAlerta("Cupo inválido", "El cupo debe ser un número entero.");
        }
    }
    ...
    private void actualizarClaseSeleccionada() {
        ...
        if (seleccionada == null) {
            mostrarAlerta("Sin selección", "Selecciona una clase en la tabla.");
            return;
        }
    ...
    private void guardarCalendario() {
        gestor.guardarClases(new ArrayList<>(listaObservable));
        mostrarAlerta("Información", "Calendario guardado en la carpeta 'Calendario'.");
    }
