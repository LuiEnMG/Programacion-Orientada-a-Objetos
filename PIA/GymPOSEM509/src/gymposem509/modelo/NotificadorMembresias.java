...
public class NotificadorMembresias implements Runnable {
    ...
    private final int diasAviso; // avisar cuando falten <= n días
    
    public NotificadorMembresias() {
        this(60_000L, 3); // cada minuto, para pruebas; para producción podrías usar 86_400_000 (1 día)
    }
    ...
    private void revisarMembresias() {
        ...
        try (FileWriter fw = new FileWriter(archivo, true);
            ...
            if (!hayAvisos) {
                out.println("Sin membresías por vencer en los próximos " + diasAviso + " días.");
            }
